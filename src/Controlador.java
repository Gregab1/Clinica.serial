    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            if (opcion == 1) {
                ...
                Paciente p1 = Vista.asignarPaciente(ListaPaciente);
                Doctor d1 = Vista.asignarDoctor(ListaDoctores);
