...
public class Vista {
    ...
    public static Paciente asignarPaciente(ArrayList<Paciente> ListaPacientes) {
      ...
      try {
        ...
        return ListaPacientes.get(n);
    }
    public static Doctor asignarDoctor(ArrayList<Doctor> ListaDoctores) {
        int n=0;
